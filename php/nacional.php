...
<table width="1168" height="191" border="0">
  ...
  <tr>
    <td>
    	<nav id="tituloseccion">|||||| NACIONAL |||||| <?php
      ...
      <table width="929" height="615" border="0">
        <tr>
          <td width="1266">
              ...
              <img src="nacional/barcenas.jpg" width="365" height="222" alt="barcenas_chorizo" class="img_not_pri"/>
          ...
          <td width="350">
          		<table width="350" height="100" border="0">
  					<tr>
                            ...
                            <img src="nacional/rajoy.jpg" width="340" height="209" alt="mariano_rajoy" />
                ...
                <table width="350" height="100" border="0">
  					<tr>
                            ...
                            <h4 id="gruponoticia"> DIA DEL TRABAJO </h4>
                             ...
                             <p><img src="nacional/sindicatos.jpg" width="340" height="233" alt="sindicatos" class="img_not_pri" /></p>
          		...
          		<table width="250" height="150" border="1">
  					<tr>
                            ...
                            <h4 id="gruponoticia"> CASA REAL </h4>
                             ...
                             <img src="nacional/rey.jpg" width="245" height="138" alt="rey viendo partido" class="img_not_pri" />
...
<p id="parrafo3"> Ha sido la primera actividad pública del monarca tras su doble operación de hernia del pasado 3 de marzo. Ya la semana pasada retomó las audiencias en Zarzuela, pero ésta ha sido la primera ocasión en la que ciudadanos y periodistas han podido verle fuera del Palacio de la Zarzuela.</p>
                ...
                <table width="250" height="150" border="1">
  					<tr>
   						 <td><article id="articulonoticia"> 
                            <h4 id="gruponoticia"> MADRID </h4>
                             <a href="nacional/retenciones_trafico_salida_puente.php"<h2 id="noticia_terciaria">Retenciones y mal tiempo en las salidas por el puente de Mayo</h2></a>
                             <p id="parrafo3">Las principales carreteras de salida de Madrid registran retenciones durante la primera mañana de la operación especial por el puente de mayo, según los datos de la Dirección General de Tráfico (DGT).</p>
                            <iframe class="youtube-player" type="text/html" width="245" height="145" src="http://www.youtube.com/embed/TOA0-RW1ucA" frameborder="0"></iframe>
                           
                           <p id="parrafo3">La DGT prevé que, coincidiendo con la fiesta nacional del 1 de mayo y la fiesta autonómica del día de la Comunidad de Madrid el jueves 2 de mayo, se produzcan en las carreteras 6 millones de desplazamientos, para lo que ha desplegado un dispositivo especial entre las 15 horas de este martes y las 24 horas del domingo 5 de mayo.</p>
                             <h5 id="leermas"> <a href="nacional/retenciones_trafico_salida_puente.php"> Leer más... </a></h5>
                      </article></td>
  					</tr>
				</table></td>
